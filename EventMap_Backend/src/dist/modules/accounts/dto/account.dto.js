...
const unique_validator_1 = require("../../../global/validators/unique.validator");
class AccountDTO {
    name;
    email;
    password_hash;
...
__decorate([
    ...
    (0, class_validator_1.MaxLength)(200),
    (0, class_validator_1.IsNotEmpty)(),
    (0, unique_validator_1.IsUnique)(account_model_1.Account, 'email', { message: 'Email đã được sử dụng' }),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], AccountDTO.prototype, "password_hash", void 0);
